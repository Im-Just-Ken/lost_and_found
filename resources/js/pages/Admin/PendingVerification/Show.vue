...
const approveFound = () => {
    router.post(
        `/admin/reported-items/pending-verification/${props.item.id}/found-approve`,
        {},
        {
            preserveScroll: true,
            onSuccess: () => {
            ...
            onError: () => {
                toast.error('Unable to approve found report');
            },
        },
    );
};

const disapproveFound = () => {
    router.post(
        `/admin/reported-items/pending-verification/${props.item.id}/found-disapproved`,
        {},
        {
            preserveScroll: true,

            onSuccess: () => {
                toast.success('Found report disapproved');
            },

            onError: () => {
                toast.error('Unable to disapprove found report');
            },
        },
    );
};
...
<template>
    <div class="mx-auto max-w-7xl space-y-6 px-6 py-12">
        ...
        <div class="flex items-start justify-between gap-4">
            <div>
                <h1 class="text-3xl font-semibold">Pending Verification</h1>
                    ...
                    <CardContent class="grid grid-cols-2 gap-3">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger as-child>
                                <Button class="w-full"> Approve Found </Button>
                            </AlertDialogTrigger>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        This will mark the item as officially
                                        verified as found.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction @click="approveFound">
                                        Yes, Approve
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>
                                        Disapprove Found Report?
                                    </AlertDialogTitle>

                                    <AlertDialogDescription>
                                        This will reject the found report and
                                        return the item to Lost status.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction @click="disapproveFound">
                                        Yes, Disapprove
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
