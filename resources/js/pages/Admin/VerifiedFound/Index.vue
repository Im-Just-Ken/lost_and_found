...
const viewItem = (id: number) => {
    router.visit(`/admin/reported-items/found/${id}`);
};
</script>
...
<template>
    <div class="space-y-6 px-10 py-6">
        <!-- HEADER -->
        <div>
            <h1 class="text-2xl font-semibold">Verified Items</h1>

            <p class="text-sm text-muted-foreground">
                View all verified found items reported by users. You can click
                on an item to see more details and manage it.
            </p>
        </div>
